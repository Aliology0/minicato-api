...
public class CreateBroadcastRequestCommandValidator : AbstractValidator<CreateBroadcastRequestCommand>
{
    public CreateBroadcastRequestCommandValidator()
    {
        ...
        RuleFor(x => x.Budget)
            .GreaterThan(0).WithMessage(Messages.Generic.Negative("Budget"));
